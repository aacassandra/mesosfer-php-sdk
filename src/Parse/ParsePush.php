...
class ParsePush
{
    ...
    public static function hasStatus($response)
    {
        ...
        return(
            ...
            isset($response['_headers'][config('mesosfer.' . $env . '.headerPushStatusId')])
        );
    }
    ...
    public static function getStatus($response)
    {
        ...
        if (!isset($headers[config('mesosfer.' . $env . '.headerPushStatusId')])) {
            // missing push status id
            return null;
        }

        // get our push status id
        $pushStatusId = $response['_headers'][config('mesosfer.' . $env . '.headerPushStatusId')];
